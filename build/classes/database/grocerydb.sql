...
INSERT INTO `items` (`item_no`, `item_name`, `discount`, `qty`, `price`, `sub_total`, `bill_no`) VALUES
(1, 'Shakti Bhog', 0, 20, 420, 8400, 5),
(3, 'Yippee', 10, 10, 45, 410, 5),
(5, 'Hide & Seek', 2, 4, 40, 160, 6),
(6, 'Limca', 10, 8, 95, 688, 6),
(3, 'Yippee', 35, 30, 45, 900, 8);
...
(5, 'Hide & Seek', 'Cookies', 40, 20, '2023-05-03', '2023-10-09', '2023-05-06'),
