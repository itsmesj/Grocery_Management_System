...
public class viewBills extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Bill No", "Customer ID", "Bill Date", "Total Amount Paid"
            }
        ));
    ...
    private void getData(){
        try{
            ...
            while(rs.next()){
                String b_id = String.valueOf(rs.getInt(1));
                String c_id = String.valueOf(rs.getInt(2));
                String b_dt = String.valueOf(rs.getString(3));
                String total = String.valueOf(rs.getDouble(4));

                String tbldata[] = {b_id, c_id, b_dt, total};
