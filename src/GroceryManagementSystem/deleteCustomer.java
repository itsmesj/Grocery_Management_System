...
public class deleteCustomer extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            Class.forName("com.mysql.jdbc.Driver");
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/grocerydb", "root", "");
            PreparedStatement psmt = con.prepareStatement("delete from customers where cus_id = ?");
            String id = jComboBox1.getSelectedItem().toString();
            psmt.setInt(1, Integer.parseInt(id));
            int i = 0;
            i = psmt.executeUpdate();
            delData();
            jComboBox1.addItem("[..Select Customer ID..]");
            getData();
            jLabel5.setText("_______________________________________");
            jLabel6.setText("_______________________________________");
                JOptionPane.showMessageDialog(this, i + " Customer deleted successfully.");
            ...
            JOptionPane.showMessageDialog(this, "Customer ID is mandatory to be chosen.");
        }
